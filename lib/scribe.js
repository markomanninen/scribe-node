(function() {
  var BaseStringExtractorImpl, DefaultApi10a, DefaultApi20, HMACSha1SignatureService, HeaderExtractorImpl, OAuth10aServiceImpl, OAuth20ServiceImpl, OAuthConfig, OAuthConstants, OAuthRequest, PlaintextSignatureService, Request, SignatureType, Timer, TimestampServiceImpl, TokenExtractor20Impl, TokenExtractorImpl, Verb, crypto, decode_data, encode_data, extract_token, http, https, object_merge, params_to_query, parser, root, sort_by_keys, sort_obj, sprintf, url;
  ...
  TokenExtractor20Impl = (function() {
    ...
    TokenExtractor20Impl.prototype.extract = function(response) {
      ...
      return new root.Token(extract_token(response, /access_token=([^&]+)/g), "", response);
    };
  ...
  TokenExtractorImpl = (function() {
    ...
    TokenExtractorImpl.prototype.extract = function(response) {
      ...
      return new root.Token(extract_token(response, /oauth_token=([^&]+)/g), extract_token(response, /oauth_token_secret=([^&]+)/g), response);
    };
