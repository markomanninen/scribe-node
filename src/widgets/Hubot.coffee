...
root.get_authorization_url = (robot, msg, api) ->
...
root.set_verification_code = (robot, msg, api) ->
  brains = init_robot_brains robot, api
  if service = root.create_service api
...
root.get_access_token = (robot, msg, api) ->
  brains = init_robot_brains robot, api
  if brains['access_token'] and service = root.create_service api
...
# for OAuth v2.0 only
root.refresh_token = (robot, msg, api) ->
